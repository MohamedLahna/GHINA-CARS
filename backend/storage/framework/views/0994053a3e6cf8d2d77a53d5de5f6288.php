                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    <form action="<?php echo e(route('admin.cars.destroy', $car->id)); ?>" method="POST"
                                        onsubmit="return confirm('Tu es sûr que tu veux supprimer?')">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HASEEB\Desktop\GHINA CARS\car-agency-api\resources\views/admin/cars/index.blade.php ENDPATH**/ ?>