        ...
        <div class="col-md-8">
            <div class="card shadow border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="<?php echo e(route('admin.marques.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="<?php echo e(route('admin.marques.index')); ?>" class="btn btn-outline-secondary px-4">
                                Annuler
                            </a>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HASEEB\Desktop\GHINA CARS BE\car-agency-api\resources\views/admin/marques/create.blade.php ENDPATH**/ ?>