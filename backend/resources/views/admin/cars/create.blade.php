                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="etat" class="form-select">
                            <option value="Neuf" {{ isset($car) && $car->etat == 'Neuf' ? 'selected' : '' }}>Neuf
                            </option>
                            <option value="Très bon état"
                                {{ isset($car) && $car->etat == 'Très bon état' ? 'selected' : '' }}>Très bon état
                            </option>
                            <option value="Bon état" {{ isset($car) && $car->etat == 'Bon état' ? 'selected' : '' }}>Bon
                                état</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
